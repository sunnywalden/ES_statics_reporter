...
class Client:
    def __init__(self):
        ...
        self.keywords_pool = redis.ConnectionPool(host=self.redis_host,
                                         port=self.redis_port,
                                         db=self.redis_keywords_base,
                                         password=self.password)
        self.redis_keywords_conn = redis.Redis(connection_pool=self.keywords_pool)
    ...
    def get_redis_keywords_client(self):
        return self.redis_keywords_conn
