...
from world_cup_day import DayClickRate
from world_cup_once_day import DayOnceClickRate
from world_cup_sources_day import DaySourceClickRate
from world_cup_sources_once_day import DaySourceOnceClickRate
from world_cup_register_day import DayRegisterClickRate
...
class sendMail:
    def __init__(self):
        ...
        self.subject = "统计结果：%s-feed-世界杯统计" % self.day  # 邮件标题
    ...
    def http_post(self, html):
        ...
        data = {
            ...
            "emailsubject": {
                "mess": html,
                "subject": "统计结果：" + self.day + "feed-世界杯统计"
            }
        }
        print data
