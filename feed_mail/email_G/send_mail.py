...
from G_day import DayClickRate
from G_once_day import DayOnceClickRate
from G_sources_day import DaySourceClickRate
from G_sources_once_day import DaySourceOnceClickRate
from G_register_day import DayRegisterClickRate
...
class sendMail:
    def __init__(self):
        ...
        self.subject = "统计结果：%s-feedG客统计" % self.day  # 邮件标题
    ...
    def http_post(self, html):
        ...
        data = {
            ...
            "emailsubject": {
                "mess": html,
                "subject": "统计结果：" + self.day + "feedG客统计"
            }
        }
        print data
