...
from PP_day import DayClickRate
from PP_once_day import DayOnceClickRate
from PP_sources_day import DaySourceClickRate
from PP_sources_once_day import DaySourceOnceClickRate
from PP_register_day import DayRegisterClickRate
...
class sendMail:
    def __init__(self):
        ...
        self.subject = "统计结果：%s-feed-PP包统计" % self.day  # 邮件标题
    ...
    def http_post(self, html):
        ...
        data = {
            ...
            "emailsubject": {
                "mess": html,
                "subject": "统计结果：" + self.day + "feed-PP包统计"
            }
        }
        print data
