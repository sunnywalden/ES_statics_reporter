...
class HandleFeed:
    def __init__(self, timestamp):
        ...
        self.res_field_channel = ['user_id', 'ctinfo', 'page_source', 'msisdn', 'client_id', 'channel']
    ...
    def first_fields(self, active_user, c, line, res):
        ...
        if 'channel' in c:
            for key in self.res_field_channel:
                res[key] = c[key]
        else:
            res['channel'] = 'hotspot-picked'
        ...
        if redis.get(search_ids):
            ...
            if isinstance(keyword_value, list) and len(keyword_value) > 0:
                ...
                for keyword in keywords:
                    ...
                    #all_keywords = ','.join(kwords)
                    #value[0]['keywords'] = all_keywords
...
if __name__ == '__main__':
    ...
    #    if day == 22:
            ...
            for hour in reversed(hours):
                new_time = (2018, 7, 28, hour, 0, 0, 0, 0, 0)
